...
function buildPanel() {
  ...
  const queueSection = el("details", { style: "border-top:1px solid #333;margin-top:6px;padding-top:8px;" },
    el("summary", { textContent: "Render queue — queue several workflows to run back to back", style: "cursor:pointer;font-size:13px;font-weight:bold;color:#7fd4ff;margin-bottom:4px;" }),
